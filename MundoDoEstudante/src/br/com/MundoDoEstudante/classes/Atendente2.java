...
public class Atendente2 extends Funcionario implements Gratificacao {
	...
	public static void calculadorGratificacao(String loja) {
		try {
			...
			if(percentual != null) {
				lista.sort(Comparator.comparing(Atendente2::getVendasSemana));
	...
	public static void ordenarVendaTotal() {
		lista.sort(Comparator.comparing(Atendente2::getVendasTotal));
		Collections.reverse(lista);
	}
	...
	public void cadastra(Atendente2 atende) {
		lista.add(atende);
	}

	public Atendente2(String nome) {
		super(nome);
		lista.add(this);
	}
